...
module.exports = {
    up: function (queryInterface, Sequelize) {
        ...
        return queryInterface.addColumn('vod', 'vod_parent_id',{
            ...
            //add column vod_type
            return queryInterface.addColumn('vod', 'vod_type',{type: Sequelize.STRING(20), defaultValue: "film", allowNull: false, after: 'id'}).then(function(success){
                //add column season_number
