...
module.exports = {
    up: function (queryInterface, Sequelize) {
        return queryInterface.addIndex('channel_stream', ['channel_id', 'stream_source_id', 'stream_mode', 'stream_resolution'], {name: 'unique_channel_stream', unique: true}).then(function(added_index){
            winston.error("Successfully created index unique_channel_stream");
