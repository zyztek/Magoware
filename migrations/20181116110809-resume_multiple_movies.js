...
module.exports = {
    up: function (queryInterface, Sequelize) {
        ...
        return queryInterface.sequelize.query('Alter table vod_resume drop foreign key vod_resume_ibfk_1')
            .then(function (result) {winston.error("removing foreign key success");})
        ...
        return queryInterface.removeIndex('vod_resume', 'vod_resume_login_id_unique')
            .then(function (result) {winston.error("removing vod_resume_login_id_unique success");})
        ...
        return queryInterface.removeIndex('vod_resume', 'login_id')
            .then(function (result) {winston.error("removing login_id unique success");})
        ...
        return queryInterface.changeColumn('vod_resume', 'login_id', {type: Sequelize.INTEGER(11), allowNull: false, references: {model: 'login_data', key: 'id', as: 'vod_resume_ibfk_1'}})
            .then(function (result) {winston.error("adding foreign key success");})
