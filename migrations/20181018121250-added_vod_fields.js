...
module.exports = {
    up: function (queryInterface, Sequelize) {
        return queryInterface.addColumn('vod', 'original_title', {type: Sequelize.STRING(128), allowNull: false, defaultValue: '', after: 'title'}).then(function(success){
            return queryInterface.addColumn('vod', 'tagline', {type: Sequelize.STRING, defaultValue: '', allowNull: false, after: 'description'}).then(function(success){
                return queryInterface.addColumn('vod', 'homepage', {type: Sequelize.STRING, defaultValue: '', allowNull: false, after: 'description'}).then(function(success){
                    return queryInterface.addColumn('vod', 'vote_average', {type: Sequelize.DOUBLE, defaultValue: 5.0, allowNull: false, after: 'rate'}).then(function(success){
                        return queryInterface.addColumn('vod', 'vote_count', {type: Sequelize.INTEGER, defaultValue: 0, allowNull: false, after: 'rate'}).then(function(success){
                            return queryInterface.addColumn('vod', 'popularity', {type: Sequelize.DOUBLE, defaultValue: 0, allowNull: false, after: 'rate'}).then(function(success){
                                return queryInterface.addColumn('vod', 'adult_content', {type: Sequelize.BOOLEAN, allowNull: false, after: 'pin_protected'}).then(function(success){
                                    return queryInterface.addColumn('vod', 'price', {type: Sequelize.DOUBLE, defaultValue: 1.0, allowNull: false}).then(function(success){
                                        return queryInterface.addColumn('vod', 'budget', {type: Sequelize.INTEGER(11), allowNull: false}).then(function(success){
                                            return queryInterface.addColumn('vod', 'revenue', {type: Sequelize.INTEGER(11), allowNull: false}).then(function(success){
                                                return queryInterface.addColumn('vod', 'original_language', {type: Sequelize.STRING(3), allowNull: false, defaultValue: 'en'}).then(function(success){
                                                    return queryInterface.addColumn('vod', 'release_date', {type: Sequelize.DATE, allowNull: false, defaultValue: '1896-12-28'}).then(function(success){
                                                        return queryInterface.addColumn('vod', 'status', {type: Sequelize.STRING(15), allowNull: false, defaultValue: 'released'}).then(function(success){
                                                            return queryInterface.addColumn('vod', 'spoken_languages', {
                                                                type: Sequelize.STRING, allowNull: false, defaultValue: '[]',
                                                                get: function () {return JSON.parse(this.getDataValue('spoken_languages'));},
