...
module.exports = {
    up: function (queryInterface, Sequelize) {
        return queryInterface.removeIndex('channel_stream', 'channelid_channelstream').then(function(removed_old_index){
            winston.error("Successfully removed old index channelid_channelstream");
    ...
    down: function (queryInterface, Sequelize) {
        return queryInterface.addIndex('channel_stream', ['channel_id', 'stream_source_id', 'stream_mode'], {name: 'channelid_channelstream', unique: true}).then(function(added_old_index){
