...
module.exports = {
    up: function (queryInterface, Sequelize) {
        return queryInterface.createTable('tv_series', {
            ...
            clicks: {type: Sequelize.INTEGER(11), allowNull: false}, //todo: do we need this?
            rate: {type: Sequelize.INTEGER, allowNull: false}, //todo: do we need this?
            ...
            episode_runtime: {type: Sequelize.INTEGER(11), allowNull: true},
            ...
            production_company: {type: Sequelize.STRING, allowNull: false, defaultValue: ''},
            origin_country: {type: Sequelize.STRING, allowNull: false, defaultValue: ''},
            ...
            mandatory_ads: {type: Sequelize.BOOLEAN, allowNull: false}, //todo: do we need this?
            revenue: {type: Sequelize.INTEGER(11), allowNull: false}, //todo: do we need this?
            budget: {type: Sequelize.INTEGER(11), allowNull: false}, //todo: do we need this?
        ...
        }).catch(function(err) {winston.error('Creating new table tv_series failed with error message: ',err.message);});
    },

    down: function (queryInterface, Sequelize) {
        return queryInterface.dropTable('tv_series')
            .catch(function(err) {winston.error('Deleting the table tv_series failed with error message: ',err.message);});
    }
};