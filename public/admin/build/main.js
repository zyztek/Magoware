...
/******/ ([
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		myApp.config(['NgAdminConfigurationProvider', function (nga) {
			...
			admin.dashboard(__webpack_require__(168)(nga, admin));
			admin.header(__webpack_require__(170));
			admin.menu(__webpack_require__(171)(nga, admin));
	...
	/***/ function(module, exports) {
		...
		exports['default'] = function (nga, admin) {
			...
			salesreport.listView().listActions(['delete', 'show']).title('<h4>Sale report <i class="fa fa-angle-right" aria-hidden="true"></i> List</h4>').fields([nga.field('user_id', 'reference').targetEntity(admin.getEntity('Users')).targetField(nga.field('username')).cssClasses('hidden-xs').label('Seller ID'), nga.field('user_username').label('Account Username'), nga.field('saledate', 'date').cssClasses('hidden-xs').label('Sale Date'), nga.field('combo_id', 'reference').targetEntity(admin.getEntity('Combos')).targetField(nga.field('name')).label('Products')]).filters([nga.field('user_username').attributes({ placeholder: 'Client' }).label('Client'), nga.field('distributorname').attributes({ placeholder: 'Distributor' }).label('Distributor'), nga.field('startsaledate', 'date').attributes({ placeholder: 'Sale date from' }).label('Start sale date'), nga.field('endsaledate', 'date').attributes({ placeholder: 'Sale date to' }).label('End sale date'), nga.field('name', 'reference').targetEntity(admin.getEntity('Combos')).attributes({ placeholder: 'Product' }).perPage(-1).targetField(nga.field('name')).label('Product')]).exportFields([salesreport.listView().fields()]);

			salesreport.showView().fields([nga.field('user_username').label('Account Username'), nga.field('user_username').label('Account Username'), nga.field('user_username').label('Account Username')]).actions(['list', 'delete', '<custom-directive></custom-directive>']);
	...
	/***/ function(module, exports) {
		...
		exports['default'] = function (nga, admin) {
			...
			salesreport.listView().title('<h4>Sales by product <i class="fa fa-angle-right" aria-hidden="true"></i> List</h4>').fields([nga.field('combo_id', 'reference').targetEntity(admin.getEntity('Combos')).targetField(nga.field('name')).label('Product'), nga.field('count', 'number').cssClasses('hidden-xs').label('Sale no.'), nga.field('saledate', 'date').cssClasses('hidden-xs').label('Last sold on'), nga.field('combo_id', 'reference').targetEntity(admin.getEntity('Combos')).targetField(nga.field('duration')).label('Duration (days)'), nga.field('combo_id', 'reference').targetEntity(admin.getEntity('Combos')).targetField(nga.field('value')).label('Value')]).filters([nga.field('startsaledate', 'date').attributes({ placeholder: 'Sale date from' }).label('Start sale date'), nga.field('endsaledate', 'date').attributes({ placeholder: 'Sale date to' }).label('End sale date')]).exportFields([salesreport.listView().fields()]);
	...
	/***/ function(module, exports) {
		...
		exports['default'] = function (nga, admin) {
			...
			salesreport.listView().title('<h4>Sales per day <i class="fa fa-angle-right" aria-hidden="true"></i> List</h4>').fields([nga.field('saledate', 'date').cssClasses('hidden-xs').label('Day'), nga.field('count', 'number').cssClasses('hidden-xs').label('Sale no.'), nga.field('combo.total_value', 'number').cssClasses('hidden-xs').label('Total earnings')]).filters([nga.field('startsaledate', 'date').attributes({ placeholder: 'Sale date from' }).label('Start sale date'), nga.field('endsaledate', 'date').attributes({ placeholder: 'Sale date to' }).label('End sale date'), nga.field('name', 'reference').targetEntity(admin.getEntity('Combos')).attributes({ placeholder: 'Product' }).perPage(-1).targetField(nga.field('name')).label('Product')]).exportFields([salesreport.listView().fields()]);
	...
	/***/ function(module, exports) {
		...
		exports['default'] = function (nga, admin) {
			...
			salesreport.listView().title('<h4>Sales per month <i class="fa fa-angle-right" aria-hidden="true"></i> List</h4>').fields([nga.field('saledate', 'date').cssClasses('hidden-xs').label('Month/year'), nga.field('count', 'number').cssClasses('hidden-xs').label('Sale no.'), nga.field('combo.total_value', 'number').cssClasses('hidden-xs').label('Total earnings')]).filters([nga.field('startsaledate', 'date').attributes({ placeholder: 'Sale date from' }).label('Start sale date'), nga.field('endsaledate', 'date').attributes({ placeholder: 'Sale date to' }).label('End sale date'), nga.field('name', 'reference').targetEntity(admin.getEntity('Combos')).attributes({ placeholder: 'Product' }).perPage(-1).targetField(nga.field('name')).label('Product')]).exportFields([salesreport.listView().fields()]);
	...
	/***/ function(module, exports) {
		...
		exports['default'] = function (nga, admin) {
			...
			salesreport.listView().title('<h4>Sales by expiration <i class="fa fa-angle-right" aria-hidden="true"></i> List</h4>').fields([nga.field('login_id', 'reference').targetEntity(admin.getEntity('LoginData')).targetField(nga.field('username')).cssClasses('hidden-xs').label('Client'), nga.field('end_date', 'date').cssClasses('hidden-xs').label('End Date')]).filters([nga.field('startsaledate', 'date').attributes({ placeholder: 'Sale date from' }).label('Start sale date'), nga.field('endsaledate', 'date').attributes({ placeholder: 'Sale date to' }).label('End sale date')]).exportFields([salesreport.listView().fields()]);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		exports['default'] = function (nga, admin) {
			...
			}).label('End Date')]).filters([nga.field('q').template('<div class="input-group"><input type="text" ng-model="value" placeholder="Search" class="form-control"></input><span class="input-group-addon"><i class="glyphicon glyphicon-search"></i></span></div>').label('').pinned(true)]).exportFields([subscription.listView().fields()]);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var _dashboardHtml = __webpack_require__(169);
