...
export default function (nga, admin) {
	...
	packageschannels.listView()
		...
		.exportFields([
         	packageschannels.listView().fields(),
        ]);


	packageschannels.deletionView()
		.title('<h4>Package Channels <i class="fa fa-angle-right" aria-hidden="true"></i> Remove <span style ="color:red;"> {{ entry.values.channel.title }} </span> from <span style ="color:red;"> {{ entry.values.package.package_name }} </span></h4>')
		.fields([
